...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='password',
            field=models.CharField(default='pbkdf2_sha256$260000$b2rfvaY6dyGkoM0xrWQdDL$aARf7Bw3N0iTNnT55lKT57XP6ry34s6t/ojs/L5TJbY=', max_length=128, verbose_name='Пароль'),
        ),
        migrations.AlterField(
